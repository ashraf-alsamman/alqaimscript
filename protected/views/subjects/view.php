<?php
include 'lang.php'; ?>
 <h1>  <?php echo Yii::t($language,'Subject') ?> <?php echo $model->title; ?></h1>
...
'data'=>array('id'=>$model->id),
 'beforeSend' => 'function(){ Loading.show();}','complete' =>'js:function(){window.location="../Subjects"}',
                                ...
                                <div class="da-panel-content">
                                    <table class="da-table da-detail-view">
                                        <tbody>
  	                                    ...
  	                                    <tr>
                                            	<th><?php echo Yii::t($language,'About') ?></th>
