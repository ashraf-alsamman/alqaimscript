...
<div style="height: 60px;"><div class="fc-day-number"><?php  ?></div><div class="fc-day-content"><div style="position: relative; height: 18px;margin: 6px 0px 0px 0px">&nbsp;
	<?php
	if ($TimeTable_class){
?><span style="font-weight: bold;font-size: 14px;padding:5px 0 0 11px"><?php echo Staff::model()->findByPk($TimeTable_class->teacher_id)->name ;?></span><br><?php
?><span style="font-weight: bold;font-size: 13px;margin-left: 11px"><?php echo Subjects::model()->findByPk($TimeTable_class->subject_id)->title ;?></span><?php
