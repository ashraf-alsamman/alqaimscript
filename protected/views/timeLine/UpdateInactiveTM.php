...
<div class="da-form-item larg"><span class="formNote"><?php echo Yii::t($language,'From') ?></span>
...
<?php echo CHtml::ajaxLink(Yii::t($language,'Cancel'),  array('CancelInactive'), array( 'type'=>'POST','update'=>"#InactiveTimeline",
'data'=>array(  
...
'live' =>'false'),array('id' => 'send-link-'.uniqid(),'class'=>'da-button red')); 
 ?>
 &nbsp;&nbsp;                                     	
<?php echo CHtml::ajaxLink(Yii::t($language,'Save'),  array('UpdateInactiveTM'), array( 'type'=>'POST','update'=>"#InactiveTimeline",'data'=>array(  
  'title'=>'js:$(\'#title\').val()' ,
