...
<h1><?php echo Yii::t($language,'Manage Timeline') ?></h1>
<?php 
 ...
 <div class="da-panel collapsible" id="ActiveTimeline">
                            	<div class="da-panel-header">
                                	<span class="da-panel-title">
                                      ...
                                      <?php echo Yii::t($language,'Active Weeks') ?>
                                    </span>
...
'confirm'=>Yii::t($language,'are you sure you want deactivate')." $DefaultLessonPlanner->title"
 ...
 ?></li> 
    <li><a href="../LessonPlanner/Update/<?php echo $DefaultLessonPlanner->id; ?>"><img alt="" src="/dashboard/images/icons/color/pencil.png"><?php echo Yii::t($language,'Update') ?></a></li>                                   
        <li><a href="Manage/<?php echo $DefaultLessonPlanner->id; ?>"><img alt="" src="/dashboard/images/icons/color/table.png"><?php echo Yii::t($language,'Manage') ?></a></li>                                   
                                        ...
                                        <tbody>
                	                        ...
                	                        <tr class="even">
                                                ...
                                                <td><?php echo $DefaultLessonPlanner->update_date  ;  ?></td>
                                                                                    ...
                                                                                    <tr class="odd">
                                            	<th><?php echo Yii::t($language,'Subject') ?></th>
...
<span class="da-panel-title"><img src="/dashboard/images/icons/black/16/list.png" alt="" />
    Inactive Weeks</span></div><div class="da-panel-content"><table id="da-ex-datatable-numberpaging" class="da-table">
...
<tr class="odd" >
<td style="padding: 0"><blockquote style="border-left: 4px solid #FF0000;background-color:#ffcdcd;color:#FF0000 "><?php echo Yii::t($language,'No Inactive Weeks') ?></blockquote></td>
</tr>
...
<?php } else {?>	
	<div  class="da-panel-content" ><table class="da-table"><tbody>
<tr class="odd" >
<td style="padding: 0"><blockquote style="border-left: 4px solid #FF0000;background-color:#ffcdcd;color:#FF0000 "><?php echo Yii::t($language,'No Weeks Exist') ?></blockquote></td>
</tr>
 </tbody></table></div><!----da-panel-content---->
<?php }?>
