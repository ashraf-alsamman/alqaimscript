...
<span class="ui-icon ui-icon-triangle-1-s"></span><a tabindex="-1"><span style="font-size:14px"><?php echo $grade_title;?></span><span class="note_m">loaded <?php echo count($data2); ?></span></a></h3>
