...
<img src="images/icons/color/ui_combo_box.png">week 2&nbsp; &nbsp; &nbsp; &nbsp; From &nbsp; &nbsp; &nbsp; &nbsp; To </span>
<span class="da-panel-toggler"></span></div>

<?php 

Yii::app()->session['add_lesson_start_ex']=0  ;
$lesson_planner_id = $model->id;
 ?>
<div class="grid_3">
<!----------------------------------------------------------------------------------->
<!----------------------------------------------------------------------------------->
...
'lesson_planner_week_id' =>$week->id,'lesson_planner_id' =>$model->id,'weekOrder' =>$weekOrder ),
