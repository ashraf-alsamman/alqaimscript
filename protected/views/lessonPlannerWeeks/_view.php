...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('from_date_ex')); ?>:</b>
	<?php echo CHtml::encode($data->from_date_ex); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('to_date_ex')); ?>:</b>
	<?php echo CHtml::encode($data->to_date_ex); ?>
	<br />
