...
<?php 
  $AllMyLessonPlanner =  LessonPlanner::model()->findByAttributes(array('adder_id'=> Yii::app()->user->id ));
...
<a href="TimeTable/<?php echo $value->id ;?>"><img src="/dashboard/images/icons/color/table.png"></a>
</td>
