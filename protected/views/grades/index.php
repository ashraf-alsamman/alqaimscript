<?php  include 'lang.php';  ?>
 ...
 <h1>
<?php echo Yii::t($language,'Grades') ?></h1>
 
<?php   $data =  Grades::model()->findAllBySql("select * from grades") ; if (count($data)>0 ) {     ?>
...
<?php echo Yii::t($language,'Grades') ?></span></div><div class="da-panel-content"><table id="da-ex-datatable-numberpaging" class="da-table">
<thead><tr><th><?php echo Yii::t($language,'Title') ?></th><th class="Null" style=" background-image: url("images/4444545.png");"></th></tr>
 ...
 <?php   
    ...
    <td class="da-icon-column" style="width:78px;padding: 1px 2px 3px 26px;">
    	<a href="Grades/<?php echo $value->id ;?>"><img src="/dashboard/images/icons/color/magnifier.png"></a>
    	<a href="Grades/Update/<?php echo $value->id ;?>"><img src="/dashboard/images/icons/color/pencil.png"></a>
