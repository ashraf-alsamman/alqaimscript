...
/**
 * This is the model class for table "classes_m".
 *
 * The followings are the available columns in table 'classes_m':
 * @property string $id
...
class Classes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('grade_id, adder_id', 'length', 'max'=>45),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, grade_id, adder_id', 'safe', 'on'=>'search'),
		);
	}
