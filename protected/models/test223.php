 ...
 */
class test223 extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return test223 the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('name, active, birth_date, sex, nationality, start_date, leaving_date, about, update_time, create_time, class_m, grade, adder_id', 'required'),
