...
<div style="clear:left"> <span class="mailbox-buttons-label"><?php echo Yii::t($language,'With selected:') ?></span> 
...
<?php
	...
	?><div class="mailbox-empty"><?php echo Yii::t($language,'No news to report.') ?></div><?php
}
