...
class User extends CActiveRecord
{
        ...
        public function rules()
        {
                ...
                return ((Yii::app()->getModule('user')->isAdmin())?array(
                        ...
                        array('username, password,createtime, lastvisit, superuser, status', 'required'),
        ...
        public function attributeLabels()
        {
                return array(
                        ...
                        'user_id' => UserModule::t("user_id"),
                        'freeze_access' => UserModule::t("freeze_access"),
                );
        }
