...
class SubjectsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'DeleteFromIndex','GoNoData','DeleteM','ChangeLang'
  ...
  $Users->save();
	...
	{    
$data = Subjects::model()->findByAttributes(array('id'=>$_POST['subject_id'])) ;
     if ($data->id){$data->delete();} 
	  $this->renderPartial('NoDataById',array('subject_id'=>$_POST['subject_id']),false,true);	
}
