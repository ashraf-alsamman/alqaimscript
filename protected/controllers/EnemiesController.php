...
'NotNowMember','ConfirmMember','NMembers','ReadTeams','ReadFriends','AjaxNEnemies','AjaxNotNowFriends','AjaxNFriends',),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Enemies'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Enemies');
	...
	{
		$model=new Enemies('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Enemies']))
			$model->attributes=$_GET['Enemies'];
	...
	{
		$model=Enemies::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='enemies-form')
		{
