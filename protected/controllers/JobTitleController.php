	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'DeleteFromIndex','GoNoData','DeleteM',
...
/////////////////////////////////////////////////////////////////////////
	...
	{    
$data = JobTitle::model()->findByAttributes(array('id'=>$_POST['id'])) ;
	...
	{
		$dataProvider=new CActiveDataProvider('JobTitle');
	 ...
	 * @param JobTitle $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='job-title-form')
		{
